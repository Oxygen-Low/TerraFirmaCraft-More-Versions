...
public final class TFCBiomes
{
    ...
    public static final BiomeExtension ICE_SHEET_MOUNTAINS = register("ice_sheet_mountains", builder().heightmap(seed -> BiomeNoise.glacialIceSurface(seed).max(BiomeNoise.glacialCirques(seed).addConstant(20)).max(BiomeNoise.glacialCirquesIceSurface(seed).addConstant(20))).surface(IceSheetSurfaceBuilder.ICE_SHEET_MOUNTAINS).spawnable().type(RiverBlendType.CAVE).noSandyRiverShores());
    ...
    public static final BiomeExtension GLACIATED_MOUNTAINS = register("glaciated_mountains", builder().heightmap(seed -> BiomeNoise.glacialCirques(seed).addConstant(20).max(BiomeNoise.glacialCirquesIceSurface(seed).addConstant(20))).surface(IceSheetSurfaceBuilder.ICE_SHEET_MOUNTAINS).spawnable().type(RiverBlendType.CAVE).noSandyRiverShores());
    ...
    public static final BiomeExtension GLACIALLY_CARVED_MOUNTAINS = register("glacially_carved_mountains", builder().heightmap(seed -> BiomeNoise.glacialCirques(seed).addConstant(20)).surface(MountainSurfaceBuilder.INSTANCE).spawnable().type(RiverBlendType.CAVE).noSandyRiverShores());
