...
public final class TFCBiomes
{
    ...
    public static final BiomeExtension ICE_SHEET = register("ice_sheet", builder().heightmap(seed -> BiomeNoise.iceSheetBaseLevel(seed).add(BiomeNoise.glacierTexture(seed))).surface(IceSheetSurfaceBuilder.NORMAL).spawnable().type(RiverBlendType.CAVE).noSandyRiverShores());
    public static final BiomeExtension ICE_SHEET_MOUNTAINS = register("ice_sheet_mountains", builder().heightmap(seed -> BiomeNoise.montaneIceSheetBaseLevel(seed).add(BiomeNoise.glacierTexture(seed)).max(BiomeNoise.glacialCirques(seed).addConstant(39)).max(BiomeNoise.glacialCirquesIceSurface(seed).addConstant(39))).surface(IceSheetSurfaceBuilder.ICE_SHEET_MOUNTAINS).spawnable().type(RiverBlendType.CAVE).noSandyRiverShores());
    public static final BiomeExtension ICE_SHEET_OCEANIC_MOUNTAINS = register("ice_sheet_oceanic_mountains", builder().heightmap(seed -> BiomeNoise.oceanicIceSheetBaseLevel(seed).add(BiomeNoise.glacierTexture(seed)).max(BiomeNoise.glacialCirquesIceSurface(seed)).max(BiomeNoise.glacialCirques(seed))).surface(IceSheetSurfaceBuilder.ICE_SHEET_OCEANIC_MOUNTAINS).spawnable().type(RiverBlendType.CAVE).noSandyRiverShores());
    public static final BiomeExtension ICE_SHEET_SHIELD_VOLCANO = register("ice_sheet_shield_volcano", builder().heightmap(seed -> BiomeNoise.glaciatedShieldVolcano(seed, BiomeNoise.hotSpotIntensity(seed)).max(BiomeNoise.shieldVolcanoIceSheetSurface(seed, BiomeNoise.hotSpotIntensity(seed)).add(BiomeNoise.glacierTexture(seed)))).surface(IceSheetShieldVolcanoSurfaceBuilder.ICE_SHEET).spawnable().type(RiverBlendType.CAVE).noSandyRiverShores());
    public static final BiomeExtension ICE_SHEET_TUYAS = register("ice_sheet_tuyas", builder().heightmap(seed -> BiomeNoise.iceSheetBaseLevel(seed).add(BiomeNoise.glacierTexture(seed))).surface(IceSheetSurfaceBuilder.NORMAL).spawnable().type(RiverBlendType.CAVE).noSandyRiverShores().tuyas(3, 0, 35, 40, true).type(RiverBlendType.CAVE));
    public static final BiomeExtension SUBGLACIAL_LAKE = register("subglacial_lake", builder().heightmap(seed -> BiomeNoise.iceSheetBaseLevel(seed).add(BiomeNoise.glacierTexture(seed))).surface(IceSheetSurfaceBuilder.HIDDEN_LAKE).carving(BiomeNoise::undergroundLakes).type(BiomeBlendType.LAKE).noRivers());
    ...
    public static final BiomeExtension ICE_SHEET_OCEANIC = register("ice_sheet_oceanic", builder().heightmap(seed -> BiomeNoise.oceanicIceSheetBaseLevel(seed).add(BiomeNoise.glacierTexture(seed))).surface(IceSheetSurfaceBuilder.OCEANIC).spawnable().type(RiverBlendType.CAVE).noSandyRiverShores());
