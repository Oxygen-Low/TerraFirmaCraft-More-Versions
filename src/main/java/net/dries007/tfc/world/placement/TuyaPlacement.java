...
public class TuyaPlacement extends PlacementModifier
{
    ...
    ).apply(instance, TuyaPlacement::new));
    ...
    public Stream<BlockPos> getPositions(PlacementContext context, RandomSource random, BlockPos pos)
    {
        ...
        {
            local = new LocalContext(seed, new TuyaNoise(seed));
        ...
        if (variants.hasTuyas())
        {
            if (center)
            {
                final BlockPos center = local.tuyaNoise.calculateCenter(pos.getX(), pos.getY(), pos.getZ(), variants.getTuyaRarity());
                if (center != null)
                {
            ...
            else if (local.tuyaNoise.calculateEasing(pos.getX(), pos.getZ(), variants.getTuyaRarity()) > this.distance)
            {
    ...
    record LocalContext(long seed, TuyaNoise tuyaNoise) {}
}
